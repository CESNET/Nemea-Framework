...
class TestMentatRuleTreeTraverser(unittest.TestCase):
    ...
    def test_01_evaluate_binops_logical(self):
        ...
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND', None, None), None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND', 0, None),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND', None, 0),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND', 0, 0),       False)
        ...
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR', None, None), None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR', 0, None),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR', None, 0),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR', 0, 0),       False)
        ...
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR', None, None), None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR', 0, None),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR', None, 0),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR', 0, 0),       False)
        ...
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND_P', None, None), None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND_P', 0, None),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND_P', None, 0),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_AND_P', 0, 0),       False)
        ...
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR_P', None, None), None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR_P', 0, None),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR_P', None, 0),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_OR_P', 0, 0),       False)
        ...
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR_P', None, None), None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR_P', 0, None),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR_P', None, 0),    None)
        self.assertEqual(traverser.evaluate_binop_logical('OP_XOR_P', 0, 0),       False)
