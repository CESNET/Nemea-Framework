...
try:
    ...
    libpath = find_library("trap")
    if not libpath:
        print("libtrap was not found. Try to set LD_LIBRARY_PATH or install libtrap.")
        sys.exit(1)
    lib = CDLL(libpath)
...
class ETimeout (TRAPException):
    pass


class EInitialized (TRAPException):
    pass


class ENotInitialized (TRAPException):
    pass


class ETerminated (TRAPException):
    pass


class EBadParams (TRAPException):
    pass


class EIOError (TRAPException):
    pass


class EHelp (TRAPException):
    pass


class EMemory (TRAPException):
    pass


class EFMTMismatch (TRAPException):
    pass
...
def autofinalize():
    """ Set up automatic cleanup when the interprete exits"""
