...
class DataAccessSetTest(unittest.TestCase):
    def runTest(self):
        ...
        a.set(0, data, pytrap.UnirecIPAddr("fd7c:e770:9b8a::465"))
        ...
        a.set(5, data, bytes(b"\xde\xad\xbe\xef"))
